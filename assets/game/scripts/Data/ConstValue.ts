export class ConstValue {
    ...
    public static readonly CoursewareKey = 'DuoMaoMao_1us28h3K6s2NB8'; //每个课件唯一的key 工程名+14位随机字符串。（脚本创建工程时自动生成）
    public static readonly GameName = 'K1J8躲猫猫4'; //游戏名中文描述，用于数据上报  （脚本创建工程时输入）
