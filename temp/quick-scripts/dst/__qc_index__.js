...
require('./assets/game/scripts/UI/Item/DuoMaoMao4');
require('./assets/game/scripts/UI/Item/Duomaomao5');
require('./assets/game/scripts/UI/Item/Duomaomao5_2');
require('./assets/game/scripts/UI/Item/FillArea');
require('./assets/game/scripts/UI/Item/FillArea2');
require('./assets/game/scripts/UI/Item/OptionItem');
require('./assets/game/scripts/UI/Item/OptionItem2');
